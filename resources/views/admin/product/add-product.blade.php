        ...
        <div class="col-md-offset-2 col-md-8">
            ...
            <div class="well">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input name="product_quantity" class="form-control">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <textarea name="short_description" class="form-control" rows="5" cols="20"></textarea>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <textarea id="editor" name="long_description" class="form-control" rows="5" cols="30"></textarea>
