                        ...
                        <div clas="single-top">
                            <div class="single-left">
                                <div class="flexslider">
                                    <ul class="slides">
                                        <li data-thumb="{{asset($catPros->product_image)}}">
                                            <div class="thumb-image"> <img src="{{asset($catPros->product_image)}}" data-imagezoom="true" class="img-responsive"> </div>
                                        </li>
                                        <li data-thumb="{{asset($catPros->product_image)}}">
                                            <div class="thumb-image"> <img src="{{asset($catPros->product_image)}}" data-imagezoom="true" class="img-responsive"> </div>
                                        </li>
                            ...
                            <div class="single-right simpleCart_shelfItem">
                                <h4>{{$catPros->product_name}}</h4>
                                <div class="block">
                                    <div class="starbox small ghosting"> </div>
                                </div>
                                <p class="price item_price">Tk. {{$catPros->product_price}}</p>
                                <div class="description">
                                    <p><span>Quick Overview : </span> {{$catPros->short_description}}</p>
                                </div>
                                <form action="{{route('add-to-cart')}}" method="POST">
                                    ...
                                    <div class="color-quality">
                                        ...
                                        <div class="quantity">
                                            ...
                                            <input type="hidden" name="id" value="{{$catPros->id}}">
                                        </div>
                                    </div>

                                    <div class="women">
                                        {{--                                    <span class="size">XL / XXL / S </span>--}}
                                        <input type="submit" class="my-cart-b item_add" value="Add to Cart" name="btn">
                                    </div>
                                </form>
                                ...
                                <div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
                                    ...
                                    <div id="myTabContent" class="tab-content">
                                        <div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
                                            <div class="descr">
                                                <h4>{{$catPros->product_name}}</h4>
                                                <p>{{$catPros->long_description}}</p>
                                                <p class="quote">~~~~~~~~Shop Wisely , Be Fashionable~~~~~~~~~</p>
                                                <div class="video">
